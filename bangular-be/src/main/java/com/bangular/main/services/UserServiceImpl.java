...
import com.bangular.main.repository.RoleRepository;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public boolean checkIfUserExist(String email) {
        // if user is not null returns true that means user does exist,
        // else user is null returns false that means user does not exist.
